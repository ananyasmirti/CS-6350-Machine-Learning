...
Original file is located at
    https://colab.research.google.com/drive/1Ki1yM7L75v2gCa8TlSsehOrxzsQxtKZQ
"""
...
train_data =  pd.read_csv('/content/train.csv', names=columns)
test_data =  pd.read_csv('/content/test.csv', names=columns)
