...
Original file is located at
    https://colab.research.google.com/drive/1S1Iuve_Yt9kwBiF4hZSPZUReCcVLvUc0
"""
...
train_data =  pd.read_csv('../DecisionTree/car/train.csv', names=columns, dtype=types)
test_data =  pd.read_csv('../DecisionTree/car/test.csv', names=columns, dtype=types)
